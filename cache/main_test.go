...
func TestReadThroughWriteBehind(t *testing.T) {
	...
	t.Setenv("PRANOR_CACHE_BACKEND_DB", dbMock.URL)
...
func TestMultiRegionReplication(t *testing.T) {
	...
	t.Setenv("PRANOR_CACHE_PEERS", peerMock.URL)
...
func TestGossipInvalidation(t *testing.T) {
	...
	os.Setenv("PRANOR_CACHE_ADDR", ts1.URL)
	os.Setenv("PRANOR_CACHE_PEERS", ts2.URL)
	defer os.Unsetenv("PRANOR_CACHE_ADDR")
	defer os.Unsetenv("PRANOR_CACHE_PEERS")
...
func TestCacheLRUEviction(t *testing.T) {
	os.Setenv("PRANOR_CACHE_MAX_KEYS", "3")
	defer os.Unsetenv("PRANOR_CACHE_MAX_KEYS")
...
func TestNamespaceIsolation(t *testing.T) {
	...
	os.Setenv("PRANOR_JWT_SECRET", secret)
