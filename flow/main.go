...
func main() {
	...
	mux.HandleFunc("/api/version", core.VersionHandler("github.com/vyuvaraj/pranor/flow", "1.0.0"))
	mux.HandleFunc("/api/v1/version", core.VersionHandler("github.com/vyuvaraj/pranor/flow", "1.0.0"))
	...
	serverHandler := core.TraceMiddleware("github.com/vyuvaraj/pranor/flow",
		rateLimiter(
			core.CORSMiddleware(
