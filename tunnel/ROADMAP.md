...
- [x] OTel trace propagation via Pranor Core
...
- [x] Wildcard DNS setup guide for `*.pranor.net`
...
- [x] Pranor Console integration (view tunnels in dashboard)
...
- [ ] **Tunnel Metrics in Pranor Console**: Live throughput, latency, and connection count dashboard.
