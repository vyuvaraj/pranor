...
// UXPreferencesManager handles user UX customization settings for Pranor Console.
...
// HTTPHandler exposes `/api/v1/console/preferences` for Pranor Console settings UI.
