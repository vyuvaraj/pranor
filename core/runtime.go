...
// MeshResolver is the interface ServRuntime uses to communicate with Pranor Mesh.
// The concrete implementation (MeshTransport / MeshClient) lives in Pranor Mesh
...
// ServRuntime is the unified host agent that every Pranor service should
...
//  2. Registers this service instance with Pranor Mesh (if resolver + SelfAddr set).
...
// heartbeatLoop sends periodic heartbeats to Pranor Mesh until ctx is cancelled.
...
// the Pranor Mesh registry REST API at meshAddr (e.g. "http://localhost:8089").
// This is the zero-dependency alternative to github.com/vyuvaraj/pranor/mesh/pkg/client.MeshTransport.
