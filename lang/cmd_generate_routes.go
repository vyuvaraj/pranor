...
func runGenerateRoutes() {
	...
	outputFile := genCmd.String("o", "", "Output .pnr file path (default: routes.pnr)")
	...
	if specFile == "" {
		fmt.Println("Usage: pranor generate routes <spec.yaml|spec.json> [-o <output.pnr>] [--server <port>] [--db <dsn>]")
		os.Exit(1)
	}
...
func generateSrvFromSpec(spec *openAPISpec, serverURL, dbURL string) string {
	...
	b.WriteString("// Auto-generated by: pranor generate routes\n")
