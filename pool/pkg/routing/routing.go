...
import (
	...
	"github.com/vyuvaraj/pranor/pool/pkg/analytics"
	"github.com/vyuvaraj/pranor/pool/pkg/migration"
...
func (srv *Server) loadMigrationsFromStore() {
	...
	if data, err := srv.storeClient.Get("pranor-db-migrations", "migrations.json"); err == nil {
...
func (srv *Server) saveMigrationsToStore() {
	...
	if err == nil {
		_ = srv.storeClient.Put("pranor-db-migrations", "migrations.json", data)
	}
}
