...
func (s *Server) resolveImportAtPosition(uri, text string, pos Position) *Location {
	...
	// Add .pnr extension if missing
	if !strings.HasSuffix(importPath, ".pnr") && !strings.HasSuffix(importPath, ".pnr.d") {
		importPath = importPath + ".pnr"
	}
...
func uriToFilePath(uri string) string {
	// file:///C:/path/to/file.pnr -> C:/path/to/file.pnr
