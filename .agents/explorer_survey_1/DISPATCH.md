...
Your task:
1. Read `/home/developer/workspace/pranor/.agents/ORIGINAL_REQUEST.md` (specifically requirements R1, R2, R3, R4).
2. Investigate the codebase at `/home/developer/workspace/pranor/packages/Pranor Auth` and `/home/developer/workspace/pranor/packages/Pranor Cache`.
...
6. Write `analysis.md` and `handoff.md` in your working directory `/home/developer/workspace/pranor/.agents/explorer_survey_1`.
