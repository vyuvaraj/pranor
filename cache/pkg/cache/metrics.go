...
// MetricsSnapshot is a serializable view of Pranor Cache telemetry.
...
// HTTPHandler returns an http.Handler that outputs live JSON metrics for Pranor Console integration.
