...
- [x] Implemented SP.G1: Read/Write query splitter (`packages/ServPool/pkg/routing/rw_splitter.go`)
- [x] Implemented SP.G2: Pre-checkout health checker (`packages/ServPool/pkg/pool/health_checker.go`)
