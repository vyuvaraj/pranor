...
// DesignerNode represents a single visual node on the Pranor Console drag-and-drop canvas.
...
// ExportToWorkflowDef converts a visual canvas layout into a runnable Pranor Flow WorkflowDef.
