...
func TestGraphQLFederation(t *testing.T) {
	...
	if resp.StatusCode == http.StatusForbidden {
		t.Skip("Skipping: GraphQL Federation requires Pranor Gate Enterprise Edition")
	}
...
func TestOIDCConfigSync(t *testing.T) {
	os.Setenv("PRANOR_JWT_SECRET", "super-secret-oidc-key")
...
func TestCostAwareLLMRouting(t *testing.T) {
	...
	if recHigh.Code == http.StatusForbidden {
		t.Skip("Skipping: Cost-Aware LLM Routing requires Pranor Gate Enterprise Edition")
	}
...
func TestPranorConsoleAdministration(t *testing.T) {
