...
import (
	...
	"github.com/vyuvaraj/serv/packages/ServGate/pkg/ai"
	"github.com/vyuvaraj/serv/packages/ServGate/pkg/autotls"
	"github.com/vyuvaraj/serv/packages/ServGate/pkg/edge"
	"github.com/vyuvaraj/serv/packages/ServGate/pkg/transcode"
	"github.com/vyuvaraj/serv/packages/ServGate/pkg/wasm"
)

func TestPhase46_StandaloneDaemonAndCLI(t *testing.T) {
	d, err := NewServGatewayDaemon("")
	if err != nil {
