...
func TestCrossServiceContracts(t *testing.T) {
	...
	fn clientCall() {
		http.post("pranor://service-b/orders", 42) // expects string, got int
	}
	`
	...
	fn clientCall() {
		http.get("pranor://service-c/users")
	}
	`
	...
	fn clientCall() {
		http.get("pranor://service-b/orders") // does not exist in module
	}
	`
	...
	fn clientCall() {
		http.post("pranor://service-b/orders", "ok")
	}
	`
