...
// UnifiedGlobalSearchEngine indexes all Servverse resources for fast prefix-matching (⌘K shortcut).
...
// Search performs multi-field prefix matching across indexed Servverse resources.
