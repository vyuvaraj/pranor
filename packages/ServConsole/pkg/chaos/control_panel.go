...
// ChaosControlPanel orchestrates runtime chaos engineering experiment triggers in ServConsole.
...
// HTTPHandler exposes `/api/v1/console/chaos/experiments` for ServConsole visual controls.
