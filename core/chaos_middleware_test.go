...
func TestChaosMiddleware_Latency(t *testing.T) {
	os.Setenv("PRANOR_CHAOS_LATENCY_MS", "50")
	defer os.Unsetenv("PRANOR_CHAOS_LATENCY_MS")
...
func TestChaosMiddleware_Drop(t *testing.T) {
	os.Setenv("PRANOR_CHAOS_DROP_RATE", "1.0")
	defer os.Unsetenv("PRANOR_CHAOS_DROP_RATE")
