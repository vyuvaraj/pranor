...
// ServctlCLI is the cluster-wide administration CLI for the Servverse platform.
...
func (sc *ServctlCLI) registerBuiltins() {
	sc.registry["get services"] = func(cmd ServctlCommand) ServctlResult {
		return ServctlResult{Command: "get services", Success: true, Output: []string{"servgate", "servqueue", "servstore", "servmesh", "servtrace"}}
	}
