...
import (
	...
	"github.com/vyuvaraj/pranor/console/pkg/auth"
	...
	dashboards   = []pkgdashboards.Dashboard{
		{
			...
			Description: "Default overview dashboard for all Pranor components",
			CreatedBy:   "system",
			CreatedAt:   "2026-06-01T00:00:00Z",
			UpdatedAt:   "2026-06-01T00:00:00Z",
			Widgets: []pkgdashboards.DashboardWidget{
				{ID: "w1", Title: "Gateway Latency", Metric: "latency", ChartType: "line", TimeRange: "1h", Service: "github.com/vyuvaraj/pranor/gate", PositionX: 0, PositionY: 0, Width: 6, Height: 4},
				{ID: "w2", Title: "Queue Throughput", Metric: "throughput", ChartType: "bar", TimeRange: "1h", Service: "github.com/vyuvaraj/pranor/pulse", PositionX: 6, PositionY: 0, Width: 6, Height: 4},
				{ID: "w3", Title: "Storage Error Rate", Metric: "error_rate", ChartType: "gauge", TimeRange: "6h", Service: "github.com/vyuvaraj/pranor/vault", PositionX: 0, PositionY: 4, Width: 4, Height: 3},
				{ID: "w4", Title: "Active Connections", Metric: "connections", ChartType: "line", TimeRange: "24h", Service: "github.com/vyuvaraj/pranor/tunnel", PositionX: 4, PositionY: 4, Width: 4, Height: 3},
...
func main() {
	...
	go func() {
		log.Printf("[console] Pranor Console running on http://localhost:%d", config.ActiveDiscovery.ConsolePort)
	...
	<-stop
	log.Println("[console] Shutting down Pranor Console gracefully...")
	ctxShut, cancelShut := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancelShut()
	_ = server.Shutdown(ctxShut)
	log.Println("[console] Pranor Console stopped.")
}
