...
func TestBranchPreviewProvisioner_ProvisionAndDestroy(t *testing.T) {
	provisioner := NewBranchPreviewProvisioner("preview.Pranor Deploy.io", 1*time.Hour)
	...
	if !strings.Contains(env.Subdomain, "feature-checkout-v2.preview.Pranor Deploy.io") {
