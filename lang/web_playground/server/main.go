...
func init() {
	...
	candidates := []string{
		filepath.Join(repoRoot, "pranor.exe"),
		filepath.Join(repoRoot, "github.com/vyuvaraj/pranor/lang"),
	}
...
func main() {
	...
	log.Printf("pranor Playground Server started on http://localhost:%d\n", *port)
