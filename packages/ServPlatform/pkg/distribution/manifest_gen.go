...
// ComponentSpec defines a Servverse component deployment specification.
...
// DistributionGenerator renders Docker Compose and Helm chart manifests for Servverse platform deployment.
...
func (dg *DistributionGenerator) GenerateHelmValues(components []ComponentSpec) DistributionManifest {
	var sb strings.Builder
	sb.WriteString("# Servverse Production Helm Values\nglobal:\n  imageTag: latest\nservices:\n")
