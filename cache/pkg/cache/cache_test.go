...
func TestNewInMemoryCacheMaxKeysEnv(t *testing.T) {
	os.Setenv("PRANOR_CACHE_MAX_KEYS", "42")
...
func TestNewInMemoryCacheInvalidMaxKeysEnv(t *testing.T) {
	os.Setenv("PRANOR_CACHE_MAX_KEYS", "invalid")
	defer os.Unsetenv("PRANOR_CACHE_MAX_KEYS")
	c := NewInMemoryCache(1 * time.Second)
	if c.maxKeys != 10000 {
...
func TestCacheStampedeProtection(t *testing.T) {
	...
	os.Setenv("PRANOR_CACHE_BACKEND_DB", server.URL)
	defer os.Unsetenv("PRANOR_CACHE_BACKEND_DB")
