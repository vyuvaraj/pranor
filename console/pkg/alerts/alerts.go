	...
	for {
		...
		case <-ticker.C:
			components := []struct {
				...
				{"github.com/vyuvaraj/pranor/trace", config.ActiveDiscovery.Trace},
				{"github.com/vyuvaraj/pranor/tunnel", config.ActiveDiscovery.Tunnel},
				{"github.com/vyuvaraj/pranor/auth", config.ActiveDiscovery.Auth},
				{"ServDB", config.ActiveDiscovery.DB},
				{"github.com/vyuvaraj/pranor/notify", config.ActiveDiscovery.Mail},
				{"github.com/vyuvaraj/pranor/flow", config.ActiveDiscovery.Flow},
				{"github.com/vyuvaraj/pranor/mesh", config.ActiveDiscovery.Mesh},
				{"github.com/vyuvaraj/pranor/chrono", config.ActiveDiscovery.Cron},
				{"github.com/vyuvaraj/pranor/cache", config.ActiveDiscovery.Cache},
				{"github.com/vyuvaraj/pranor/hub", config.ActiveDiscovery.Registry},
				{"github.com/vyuvaraj/pranor/deploy", config.ActiveDiscovery.Cloud},
...
func HandlePostmortem(w http.ResponseWriter, r *http.Request) {
	...
	if !found {
		targetAlert = Alert{
			ID:        alertID,
			Component: "github.com/vyuvaraj/pranor/gate",
			Type:      "HighLatency",
	...
	pm := Postmortem{
		...
		ActionItems: []string{
			...
			"Update connection pooling timeout defaults in Pranor Pool",
		},
	}
