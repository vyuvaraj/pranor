...
func HandleConsoleCronJobs(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodGet {
		...
		if err != nil {
			WriteJSONError(w, r, "Failed to fetch jobs from Pranor Chrono: "+err.Error(), "ERR_CRON_UNREACHABLE", http.StatusBadGateway)
			return
		}
	...
	if r.Method == http.MethodPost {
		...
		resp, err := client.Do(req)
		if err != nil {
			WriteJSONError(w, r, "Failed to create job in Pranor Chrono: "+err.Error(), "ERR_CRON_UNREACHABLE", http.StatusBadGateway)
			return
		}
		defer resp.Body.Close()
...
func HandleConsoleCronJobsItem(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodPost && action == "run" {
		...
		resp, err := client.Do(req)
		if err != nil {
			WriteJSONError(w, r, "Failed to trigger job in Pranor Chrono: "+err.Error(), "ERR_CRON_UNREACHABLE", http.StatusBadGateway)
			return
		}
		defer resp.Body.Close()
	...
	if r.Method == http.MethodDelete && action == "" {
		...
		resp, err := client.Do(req)
		if err != nil {
			WriteJSONError(w, r, "Failed to delete job in Pranor Chrono: "+err.Error(), "ERR_CRON_UNREACHABLE", http.StatusBadGateway)
			return
		}
		defer resp.Body.Close()
...
func HandleConsoleCacheStats(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := client.Do(req)
	if err != nil {
		WriteJSONError(w, r, "Failed to fetch stats from Pranor Cache: "+err.Error(), "ERR_CACHE_UNREACHABLE", http.StatusBadGateway)
		return
	}
	defer resp.Body.Close()
...
func HandleConsoleCacheClear(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := client.Do(req)
	if err != nil {
		WriteJSONError(w, r, "Failed to clear Pranor Cache: "+err.Error(), "ERR_CACHE_UNREACHABLE", http.StatusBadGateway)
		return
	}
	defer resp.Body.Close()
...
func HandleConsoleMeshInstances(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := client.Do(req)
	if err != nil {
		WriteJSONError(w, r, "Failed to fetch instances from Pranor Mesh: "+err.Error(), "ERR_MESH_UNREACHABLE", http.StatusBadGateway)
		return
	}
	defer resp.Body.Close()
...
func HandleConsoleRegistryPackages(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := client.Do(req)
	if err != nil {
		WriteJSONError(w, r, "Failed to fetch packages from Pranor Hub: "+err.Error(), "ERR_REGISTRY_UNREACHABLE", http.StatusBadGateway)
		return
	}
	defer resp.Body.Close()
...
func HandleConsoleCloudServices(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := client.Do(req)
	if err != nil {
		WriteJSONError(w, r, "Failed to fetch services from Pranor Deploy: "+err.Error(), "ERR_CLOUD_UNREACHABLE", http.StatusBadGateway)
		return
	}
	defer resp.Body.Close()
...
func HandleConsoleCloudServicesItem(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := client.Do(req)
	if err != nil {
		WriteJSONError(w, r, "Failed to communicate with Pranor Deploy: "+err.Error(), "ERR_CLOUD_UNREACHABLE", http.StatusBadGateway)
		return
	}
	defer resp.Body.Close()
...
func HandleConsoleCloudDeploy(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := client.Do(req)
	if err != nil {
		WriteJSONError(w, r, "Failed to deploy on Pranor Deploy: "+err.Error(), "ERR_CLOUD_UNREACHABLE", http.StatusBadGateway)
		return
	}
	defer resp.Body.Close()
...
func HandleConsoleCloudHistory(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := client.Do(req)
	if err != nil {
		WriteJSONError(w, r, "Failed to fetch history from Pranor Deploy: "+err.Error(), "ERR_CLOUD_UNREACHABLE", http.StatusBadGateway)
		return
	}
	defer resp.Body.Close()
...
func HandleDocsSpec(w http.ResponseWriter, r *http.Request) {
	...
	services := []struct {
		...
		{"github.com/vyuvaraj/pranor/gate", config.ActiveDiscovery.Gate},
		{"github.com/vyuvaraj/pranor/vault", config.ActiveDiscovery.Store},
		{"github.com/vyuvaraj/pranor/pulse", config.ActiveDiscovery.Queue},
		{"github.com/vyuvaraj/pranor/auth", config.ActiveDiscovery.Auth},
