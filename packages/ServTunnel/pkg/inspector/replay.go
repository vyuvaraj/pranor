...
// RequestInspectorBuffer captures and stores HTTP transactions in a ring buffer for ServConsole replay.
...
// HTTPHandler exposes `/api/v1/tunnel/inspector` for ServConsole visual request replay.
