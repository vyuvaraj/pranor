...
func TestRetentionPolicies(t *testing.T) {
	os.Setenv("PRANOR_TRACE_DEFAULT_TTL", "10ms")
	os.Setenv("PRANOR_TRACE_TTL_KEEP_SERVICE", "10m")
	defer func() {
		os.Unsetenv("PRANOR_TRACE_DEFAULT_TTL")
		os.Unsetenv("PRANOR_TRACE_TTL_KEEP_SERVICE")
	}()
...
func TestPerServiceSamplingRate(t *testing.T) {
	os.Setenv("PRANOR_TRACE_SAMPLING_RATE_HIGH_SERVICE", "100")
	os.Setenv("PRANOR_TRACE_SAMPLING_RATE_LOW_SERVICE", "0")
	defer func() {
		os.Unsetenv("PRANOR_TRACE_SAMPLING_RATE_HIGH_SERVICE")
		os.Unsetenv("PRANOR_TRACE_SAMPLING_RATE_LOW_SERVICE")
	}()
...
func TestAdaptiveSamplingThreshold(t *testing.T) {
	os.Setenv("PRANOR_TRACE_ADAPTIVE_ERROR_THRESHOLD", "0.25")
	defer os.Unsetenv("PRANOR_TRACE_ADAPTIVE_ERROR_THRESHOLD")
