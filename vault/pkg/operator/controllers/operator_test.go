...
func TestClusterReconciler_Basic(t *testing.T) {
	...
	// Create a mock PranorVaultCluster resource
	cluster := &operv1.PranorVaultCluster{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "test-cluster",
			Namespace: "default",
		},
		Spec: operv1.PranorVaultClusterSpec{
			Replicas: 3,
			Image:    "Pranor Vault:latest",
		},
	}
	...
	r := &PranorVaultClusterReconciler{
		Client: fakeClient,
		Log:    logr.Discard(),
	}
