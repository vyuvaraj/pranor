...
│   ├── lexer.go             # Tokenizer — converts .pnr source to tokens
...
├── examples/                # Example .pnr programs demonstrating language features
├── scripts/
...
├── test_sample.pnr          # Sample test file
└── main.pnr                 # Sample service entry point
```
...
- The VS Code extension under `vscode-support/extension/` provides `.pnr` syntax highlighting via TextMate grammar.
