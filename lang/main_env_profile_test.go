...
func TestEnvironmentProfileYAMLConfig(t *testing.T) {
	// 1. Create a temporary .pnr test file
	tmpFile, err := os.CreateTemp("", "test_env_*.pnr")
	if err != nil {
...
`
	...
	// 5. Set PRANOR_ENV environment variable
	os.Setenv("PRANOR_ENV", "staging")
	defer os.Unsetenv("PRANOR_ENV")
