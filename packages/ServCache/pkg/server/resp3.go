// Package server provides server transports for ServCache, including RESP3 protocol support.
package server
...
// RESP3Server wraps a ServCache instance and handles Redis RESP3 wire connections.
type RESP3Server struct {
	cache cache.Cache
}

// NewRESP3Server creates a new RESP3 protocol server wrapper over a ServCache.
...
// ExecuteCommand dispatches parsed RESP3 commands against ServCache.
