...
func TestPhase35UtilityNamespacesPart4(t *testing.T) {
	tmpFile, err := os.CreateTemp("", "test_utility_namespaces_part4_*.pnr")
	if err != nil {
	...
	// Compile and run the test using pranor compiler (make sure TESTING=true is passed to localhost bind)
