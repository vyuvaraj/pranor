module github.com/vyuvaraj/pranor/agent
...
replace github.com/vyuvaraj/pranor/llm => ../llm

require github.com/vyuvaraj/pranor/core v0.0.0-00010101000000-000000000000
