...
- Write `TEST_INFRA.md` at `/home/developer/workspace/serv/TEST_INFRA.md`.
- Write `TEST_READY.md` at `/home/developer/workspace/serv/TEST_READY.md` when tests pass.
...
- **Code layout**: Go module `serv`, packages under `packages/*` or root.
