...
// PranorVaultClusterReconciler reconciles a PranorVaultCluster object
type PranorVaultClusterReconciler struct {
	client.Client
	Log logr.Logger
}
...
func (r *PranorVaultClusterReconciler) newHeadlessService(c *operv1.PranorVaultCluster) *corev1.Service {
	labels := map[string]string{
		"app.kubernetes.io/name":     "github.com/vyuvaraj/pranor/vault",
	...
	return &corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			...
			OwnerReferences: []metav1.OwnerReference{
				*metav1.NewControllerRef(c, operv1.GroupVersion.WithKind("PranorVaultCluster")),
			},
		},
...
func (r *PranorVaultClusterReconciler) newMainService(c *operv1.PranorVaultCluster) *corev1.Service {
	labels := map[string]string{
		"app.kubernetes.io/name":     "github.com/vyuvaraj/pranor/vault",
		"app.kubernetes.io/instance": c.Name,
	}
...
func (r *PranorVaultClusterReconciler) newPdb(c *operv1.PranorVaultCluster) *policyv1.PodDisruptionBudget {
	labels := map[string]string{
		"app.kubernetes.io/name":     "github.com/vyuvaraj/pranor/vault",
		"app.kubernetes.io/instance": c.Name,
	}
...
func (r *PranorVaultClusterReconciler) newStatefulSet(c *operv1.PranorVaultCluster) *appsv1.StatefulSet {
	labels := map[string]string{
		"app.kubernetes.io/name":     "github.com/vyuvaraj/pranor/vault",
		"app.kubernetes.io/instance": c.Name,
	}
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					...
					Containers: []corev1.Container{
						{
							Name:            "github.com/vyuvaraj/pranor/vault",
							Image:           c.Spec.Image,
