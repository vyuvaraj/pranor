...
You are Forensic Auditor M3 for ServCron (CR.G1, CR.G2, CR.G4).
...
Tasks:
1. Perform integrity verification on `packages/ServCron/pkg/cron/cron.go` and `packages/ServCron/pkg/config/jobs_loader.go`.
