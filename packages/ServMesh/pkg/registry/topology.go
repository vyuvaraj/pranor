...
// TopologyGraph maintains live inter-service dependency links for ServConsole force-directed graph rendering.
...
// HTTPHandler exposes REST endpoint `/api/v1/topology` for ServConsole visual topology rendering.
