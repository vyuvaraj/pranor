...
func TestNewPranorVaultTemplateStore(t *testing.T) {
	s := NewPranorVaultTemplateStore(nil)
	if s == nil {
		t.Fatal("expected NewPranorVaultTemplateStore to return initialized struct")
	}
	if s.Client != nil {
