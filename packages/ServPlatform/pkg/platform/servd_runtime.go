...
// ComponentStatus represents the runtime status of an embedded Servverse component.
type ComponentStatus struct {
	Name    string `json:"name"`
	Running bool   `json:"running"`
}

// ServdRuntime manages the single-binary unified runtime embedding all Servverse components.
