...
func TestPhase35UtilityNamespacesPart7(t *testing.T) {
	tmpFile, err := os.CreateTemp("", "test_utility_namespaces_part7_*.pnr")
	if err != nil {
	...
	srvContent := `
	extern fn new_mock(val) from "go:github.com/vyuvaraj/pranor/lang/runtime:NewMockReceiver"

	extern from "go:github.com/vyuvaraj/pranor/lang/runtime" {
