...
// interface. The concrete implementation (HTTPLockClient) talks to Pranor Mesh's
// /api/lock/* endpoints. A no-op or test double can be injected without
// touching Pranor Mesh at all.
// ──────────────────────────────────────────────────────────────────────────────

// LockEntry mirrors the lock.LockEntry type returned by Pranor Mesh.
...
// Pranor Mesh's HTTPLockClient satisfies it; tests can inject a NoOpLocker.
...
// ──────────────────────────────────────────────────────────────────────────────
// HTTPLockClient — production implementation backed by Pranor Mesh
// ──────────────────────────────────────────────────────────────────────────────
...
// NewHTTPLockClient creates a lock client pointing at the given Pranor Mesh address.
...
// NewHTTPLockClientFromEnv reads PRANOR_MESH_ADDR (falling back to
// http://localhost:8089) and returns a configured client.
func NewHTTPLockClientFromEnv() *HTTPLockClient {
	addr := getenv("PRANOR_MESH_ADDR", "http://localhost:8089")
