...
// DeliveryMetrics tracks aggregate mail delivery events for Pranor Console visual analytics.
...
// HTTPHandler exposes `/api/v1/mail/analytics` endpoint for Pranor Console dashboard graphs.
