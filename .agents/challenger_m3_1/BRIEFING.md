...
## Mission
Empirically verify ServCron (CR.G1, CR.G2, CR.G4): DAG pipeline, retry backoff & jitter, YAML loading/watching, concurrent execution, and race detector.
...
## Review Scope
- **Files to review**: `packages/ServCron/...`
