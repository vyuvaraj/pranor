...
import (
	...
	"github.com/vyuvaraj/pranor/flow/pkg/engine"
...
func TestPranorFlowDAGExecution(t *testing.T) {
	setupTest()
...
func TestPranorFlowDurableExecution(t *testing.T) {
	setupTest()
	mux := http.NewServeMux()
	mux.HandleFunc("/api/workflows/define", handleDefine)
	mux.HandleFunc("/api/workflows/execute", handleExecute)
...
func TestPranorFlowSagaCompensation(t *testing.T) {
	setupTest()
	mux := http.NewServeMux()
	mux.HandleFunc("/api/workflows/define", handleDefine)
	mux.HandleFunc("/api/workflows/execute", handleExecute)
...
func TestPranorFlowRetriesAndTimeouts(t *testing.T) {
	setupTest()
	mux := http.NewServeMux()
	mux.HandleFunc("/api/workflows/define", handleDefine)
	mux.HandleFunc("/api/workflows/execute", handleExecute)
...
func TestPranorFlowHumanApprovalGates(t *testing.T) {
	setupTest()
	mux := http.NewServeMux()
	mux.HandleFunc("/api/workflows/define", handleDefine)
	mux.HandleFunc("/api/workflows/execute", handleExecute)
...
func TestPranorFlowHistoryAndReplay(t *testing.T) {
	setupTest()
	mux := http.NewServeMux()
	mux.HandleFunc("/api/workflows/define", handleDefine)
	mux.HandleFunc("/api/workflows/execute", handleExecute)
...
func TestPranorFlowDAGValidationAndVisualization(t *testing.T) {
	setupTest()
	mux := http.NewServeMux()
...
func TestVisualDesignerOSS(t *testing.T) {
	...
	if !strings.Contains(res.Error, "requires Pranor Flow Enterprise Edition") {
